...
class OrderCommitView(View):
    ...
    def post(self, request):
        ...
        # 校验支付方式
        if pay_method not in ['0', '1', '2', '3', '4']:
            return JsonResponse({'res': 2, 'errmsg': '非法的支付方式'})
...
class OrderPayView(View):
    ...
    def post(self, request):
        ...
        total_pay = order.total_price + order.tran_price  # Decimal
